...
public class Daten {
    ...
    public final static String VERSIONID          = "2.2.1_10";   // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta-Version z.B. 1.4.0_#1
    public final static String VERSIONRELEASEDATE = "xx.05.2015";  // Release Date: TT.MM.JJJJ
