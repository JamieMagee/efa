...
public class EmilConfigFrame extends JDialog implements ActionListener {
  ...
  private void jbInit() throws Exception  {
    ...
    efwdirButton.setIcon(new ImageIcon(EmilConfigFrame.class.getResource("/img/prog_open.gif")));
    ...
    cvsdirButton.setIcon(new ImageIcon(EmilConfigFrame.class.getResource("/img/prog_open.gif")));
    ...
    stdcvsButton.setIcon(new ImageIcon(EmilConfigFrame.class.getResource("/img/prog_save.gif")));
