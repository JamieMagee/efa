...
public class EfaBaseFrame extends BaseDialog implements IItemListener {
    ...
    private void iniGuiBase() {
        setIconImage(Toolkit.getDefaultToolkit().createImage(EfaBaseFrame.class.getResource("/img/efa_icon.png")));
    ...
    DestinationRecord findDestination(long validAt) {
        ...
        if (r == null && s != null && s.length() > 0) {
            // not found; try to find as postfixed with de.nmichael.efa.boathouse name
